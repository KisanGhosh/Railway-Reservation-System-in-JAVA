...
public class CancelTickets {
    ...
    public static void display(){
        ...
        numberColumn.setCellValueFactory(new PropertyValueFactory<>("train_no"));
        ...
        dateColumn.setCellValueFactory(new PropertyValueFactory<>("datetravel"));
        ...
        seatColumn.setCellValueFactory(new PropertyValueFactory<>("seat_no"));

        //class
        TableColumn<Passenger, String> wlColumn = new TableColumn<>("Waitlist number");
        wlColumn.setMinWidth(200);
        wlColumn.setCellValueFactory(new PropertyValueFactory<>("wl_no"));
        ...
        button.setOnAction(e -> {
            ...
            String sql = "SELECT * FROM passenger WHERE pnr='"+ pnrInput + "';";
        ...
        button2.setOnAction(e -> {
            ...
            String pnrInput = pnr.getText();
            String sql = "SELECT * FROM passenger WHERE pnr='"+ pnrInput + "' AND pid='"+ pidInput +"';";
            Statement statement = null;
            try {
                statement = connection.createStatement();
                ResultSet resultSet = statement.executeQuery(sql);
                ...
                if (!resultSet.isBeforeFirst()){
                    ...
                    String sql1 = "DELETE FROM passenger WHERE pid ='" + pidInput +"';";
                    ...
                    String sql2 = "SELECT * FROM passenger WHERE pnr='"+ pnrInput + "';";
                    //Statement statement1 = null;

                    String sql3 = "UPDATE passenger SET wl_no = wl_no - 1 " +
                            "WHERE wl_no > "+ wlNo1 +" AND train_no='" + currTno + "' AND datetravel='" + currDate + "' AND type='"+ currClass + "';";
                    String sql4 = "UPDATE passenger SET seat_number = '"+ seatNo1 +
                            "' WHERE wl_no = 0 AND seat_no = 0 AND train_no='" + currTno + "' AND datetravel='" + currDate + "' AND type='"+ currClass + "';";
                    String sql5 = "UPDATE availability_info SET "+ classCol + "= "+ classCol+ "+1 " +
                            "WHERE train_number='" + currTno + "' AND datetravel='" + currDate + "';";

                    String sql6 = "SELECT * FROM passenger WHERE wl_no > 0 AND train_no='" + currTno + "' AND datetravel='" + currDate  + "' AND class='"+ currClass + "';";

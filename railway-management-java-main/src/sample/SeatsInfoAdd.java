...
public class SeatsInfoAdd {
    ...
    public static void display()  {
        ...
        button.setOnAction(e -> {
            ...
            try {
                String sql1 = "SELECT * FROM availability_info WHERE train_number='"+ tnoInput + "' AND datetravel='" + dateInput.toString() +"';";
                ...
                if(resultSet.next()){
                   ...
                   String sql3 = "UPDATE availability_info SET sleeper='" + sleeperSeatsInput + "', ac_two='" + acTwoSeatsInput + "', ac_three='" + acThreeSeatsInput
                    ...
                    if(!statement.executeQuery(sql2).next()){
                        ...
                        if(tnoInput.equals("")){
                            ...
                            String sql = "INSERT INTO availability_info VALUES('"+ tnoInput +"','"+ sleeperSeatsInput +  "','" +  acTwoSeatsInput +  "','"+
